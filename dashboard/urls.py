...
urlpatterns = [
    ...
    path('employer/vacancy/expired', employer.expired_vacancy, name='expired-vacancy'),
    ...
    path('ajax/expired/vacancies', employer.ajax_expired_vacancy, name='ajax-expired-vacancy'),
    ...
    path('controller/ajax/manage-type', controller.ajax_manage_type, name='ajax-controller-manage-type'),
